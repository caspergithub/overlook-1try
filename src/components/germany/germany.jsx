...
function Germany(props) {
    ...
    const getSelectedCities = () => {
        let url = `https://api.mediehuset.net/overlook/countries/5`
        fetch(url)
            ...
            <section className={Style.mainGridWrapper}>
                ...
                <div className={Style.mainGrid}>
                    <div className={Style.grid1}>
                        <Link to='/' className={Style.bca}><span>Hotel Overlook</span></Link> &rsaquo; <span>Hoteller og Destinationer</span> &rsaquo; <span>Tyskland</span>
                        <h2 className={Style.fontWeight200}>Vores hoteller i Tyskland</h2>
