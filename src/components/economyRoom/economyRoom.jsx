...
function EconomyRoom() {
    ...
    const getRoomData = () => {
        let url = `https://api.mediehuset.net/overlook/rooms/1`
        fetch(url)
            .then(response => response.json())
    ...
    return (
        <>
            <div className={Style.heroImageWrapper}>
                <div className={Style.heroImage} style={{ backgroundImage: `url(${AllRooms ? AllRooms.items[1].images[0].image : null})` }}></div>
                ...
                <div className={Style.mainGrid}>
                    ...
                    <div>
                        ...
                        <section className={Style.theSelectedRoomsImages}>
                            {AllRooms.items
                                ? AllRooms.items[1].images.map(({ name, description, id, image }) => (
                                    <div key={id}>
