...
function SuperiorRoom() {
    ...
    const getRoomData = () => {
        let url = `https://api.mediehuset.net/overlook/rooms/2`
        fetch(url)
            .then(response => response.json())
    ...
    return (
        <>
            <div className={Style.heroImageWrapper}>
                <div className={Style.heroImage} style={{ backgroundImage: `url(${AllRooms ? AllRooms.items[3].images[0].image : null})` }}></div>
                ...
                <div className={Style.mainGrid}>
                    ...
                    <div>
                        ...
                        <section className={Style.theSelectedRoomsImages}>
                            {AllRooms.items
                                ? AllRooms.items[3].images.map(({ name, description, id, image }) => (
                                    <div key={id}>
                        ...
                        <div className={Style.facilitiesGrid1}>
                            <img src={BedIcon} alt="" />
                            <p className={Style.fontWeight200}>Sengetyper: {RoomData.item ? RoomData.item.facilities[11].title : null}</p>
                        </div>
